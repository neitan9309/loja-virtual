...
// ======================================================
// DROPDOWNS MOBILE (CORRIGIDO - não bloqueia navegação)
// ======================================================
document.querySelectorAll('.dropdown').forEach(dropdown => {
    ...
    if (toggle) {
        toggle.addEventListener('click', function(e) {
            ...
            const isRealLink = !isHash;

            // ✅ No mobile, se o link é '#', apenas abre o submenu
            // ✅ No mobile, se o link é real, deixa navegar
            // ✅ No desktop, sempre navega (nunca previne)
            if (isMobile && isHash) {
                e.preventDefault();
                e.stopPropagation();
            ...
            // Desktop ou mobile com href real → navega
        });
    }
...
function nextSlideFunc() { showSlide((currentSlide + 1) % slides.length); }
function prevSlideFunc() { showSlide((currentSlide - 1 + slides.length) % slides.length); }
            ...
            tree.forEach(category => {
                ...
                if (category.children && category.children.length > 0) {
                    ...
                    category.children.forEach(gender => {
                        ...
                        // ✅ Título clicável que leva para /categoria
